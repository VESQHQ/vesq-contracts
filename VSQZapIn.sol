...
///@author Zapper
///@notice This contract adds liquidity to SushiSwap pools on Polygon using MATIC or any ERC20 Tokens.
...
interface IVSQBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract VSQ_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (IVSQBondDepository => address) public allowedPairs;
    mapping (IVSQBondDepository => address) public allowedReserves;
    ...
    constructor()
    {
        ...
        //allowedPairs
        //allowedPairs[IVSQBondDepository(0xc26850686ce755FFb8690EA156E5A6cf03DcBDE1)] = 0xf64e1c5B6E17031f5504481Ac8145F4c3eab4917;
        //allowedPairs[IVSQBondDepository(0xA184AE1A71EcAD20E822cB965b99c287590c4FFe)] = 0x113f413371fC4CC4C9d6416cf1DE9dFd7BF747Df;

        //allowedReserves
        //allowedReserves[IVSQBondDepository(0x694738E0A438d90487b4a549b201142c1a97B556)] = 0x130966628846BFd36ff31a822705796e8cb8C18D;
        //allowedReserves[IVSQBondDepository(0xE02B1AA2c4BE73093BE79d763fdFFC0E3cf67318)] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    }
    ...
    function ZapInLp(
        ...
        IVSQBondDepository _bondDepository,
        uint256 _amount,
